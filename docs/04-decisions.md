...
**Status:** Accepted for Nannestad Prototype-0 multi-tile compiler direction — 2026-08-19. Pending SENTINEL integration to `main`; not a whole-Norway terrain-source decision.  
